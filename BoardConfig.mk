...
TARGET_2ND_CPU_ABI := armeabi-v77
...
TARGET_KERNEL_CONFIG := c2q_kor_singlew_defconfig
TARGET_KERNEL_SOURCE := kernel/samsung/c2q
...
# Partitions
BOARD_FLASH_BLOCK_SIZE := 16777216 # (BOARD_KERNEL_PAGESIZE * 64)
BOARD_BOOTIMAGE_PARTITION_SIZE := 71303168
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 86888468
BOARD_HAS_LARGE_FILESYSTEM := true
BOARD_SYSTEMIMAGE_PARTITION_TYPE := ext4
BOARD_USERDATAIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_VENDORIMAGE_FILE_SYSTEM_TYPE := ext4
TARGET_COPY_OUT_VENDOR := vendor
BOARD_SUPER_PARTITION_SIZE := 10817110016
BOARD_SUPER_PARTITION_GROUPS := samsung_dynamic_partitions
BOARD_SAMSUNG_DYNAMIC_PARTITIONS_PARTITION_LIST := system system system vendor product odm
BOARD_SAMSUNG_DYNAMIC_PARTITIONS_SIZE := 10817110016
...
# Fox recovery compression hack
FOX_DRASTIC_SIZE_REDUCTION += 1
TW_USE_OF_LZMA_COMPRESSION += 1
...
BOARD_HAS_NO_REAL_SDCARD := tru
TW_EXCLUDE_MTP := true
TW_HAS_DOWNLOAD_MODE := false
TW_EXCLUDE_ADB := true
TW_EXCLUDE_USB_STORAGE := true
TW_USES_LZMA_COMPRESSION := true
